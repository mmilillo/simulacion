...
Original file is located at
    https://colab.research.google.com/drive/1QVwZ6eRc2-r4LpOSFa51Cyeir5DCk4zf
"""
...
class ParticleBox:
	...
	def step(self, dt):
		...
		choco_X_p1 = (abs(self.state[:, 0] - x_p1)) <= (self.size )
		choco_Y_p1 = (abs(self.state[:, 1] - y_p1)) <= (self.size )

		#modifico velocidad de las que chocan con p1, componente x del vector
		self.state[choco_X_p1 & choco_Y_p1 & no_es_x_p1, 2] = (vx_p1 * -1)

		matriz_velocidades = self.state[choco_X_p1 & choco_Y_p1 & no_es_x_p1, 2:]
		matriz_normales -= self.state[0,2:]
		#matriz_normales_unitarios = matriz_normales[:,:]  self.state[0,2:]
